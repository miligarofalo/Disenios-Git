...
Respuesta: El número de hijos parece tener un impacto negativo significativo en el ingreso anual. Las variables de género, edad y educación universitaria no presentan efectos significativos en este conjunto de datos, ya que sus valores p son altos. Por cada hijo adicional, el ingreso anual disminuye en promedio en \$13,400.18
...
**Ejercicio 2:** convierta los coeficientes en OR, como los interpreta? Las personas con educación primaria tienen 2.72 veces más probabilidades de votar por Trump en comparación con la categoría de referencia (Doctorado).
