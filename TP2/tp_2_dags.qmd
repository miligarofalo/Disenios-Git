...
El modelo no debería controlar por lluvias e Imperm porque son colliders. Luego, con actividad si debemos controlar porque es una variable confusora, es decir, el modelo teórico debería incluir:

Inundaciones= β0 ​+ β1 \* Tropicalizacion + β2​ \* Obra_publica + β3 \* Actividad + ϵ
